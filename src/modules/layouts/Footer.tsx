        ...
        <article className="bg-gray-regular w-full">
            <section className='container xl:max-w-[1245px] mx-auto gap-28 md:gap-[112px] flex flex-col sm:px-0 px-5'>
                <div className='flex gap-8 xl:gap-36 flex-col xl:flex-row pt-28 items-center'>
                    <h2 className='text-adptive-ml font-bold xl:max-w-[70%] max-w-full'>Get in touch with us today to see how we can help you scale your business.</h2>
                    <Button className='w-[167px] h-12 text-[13px] self-start md:self-end' label='Compare Rates' />
                </div>
