  ...
  return (
    <article className="flex mx-auto xl:max-w-[1100px] 2xl:max-w-[1245px] flex-col py-28 gap-14 sm:px-0 px-6">
      ...
      <p className="text-[17px]">
        ...
        (collectively, the “Terms of Use” or “Agreement”). Please read the Terms
        of Use carefully, as they contain important information about
        limitations of liability and resolution of disputes through arbitration
        rather than in court. By accessing or using this Website, arranging for
        courier services on this Website, or contacting our call center agents,
      ...
      <p className="text-[17px]">
        ...
        these Terms, as amended or modified from time to time, you agree that
        your sole remedy is to cease using the Website. We retain the right at
      ...
      <p className="text-[17px]">
        ...
        by these Terms, as amended or modified from time to time, (ii) affirm
        that you are eighteen (18) years of age or older and are fully able and
        competent to enter into the terms, conditions, obligations, affirmation,
        representations, and warranties set forth herein, and (iii) will only
      ...
      <p className="text-[17px]">
        ...
        may be due to your temporary location or use of the site outside the EU
